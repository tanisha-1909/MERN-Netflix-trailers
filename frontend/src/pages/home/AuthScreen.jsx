...
const AuthScreen = () => {
  ...
  return(
    ...
    {/*seperator*/}
    <div className="h-2 w-full bg-[#232323] arial-hidden=true"/>
    ...
    <div className="='py-10 bg-black text-white">
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
                ...
                <div className="flex-1 relative">
                    ...
                    <video className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h1/2 z-10"
                        playsInline
                        autoPlay={true}
                        muted
                        loop
        ...
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2">
                ...
                <div className="flex-1 ">
                    <div className="relative">
                        ...
                        className="mt-4"
                        />
                        <div className="flex items-center gap-2 absolute bottom-5 left-1/2 -translate-x-1/2 bg-black w-3/4 lg:w-1/2 h-24 border border-slate-500 rounder-md px-2">
                            <img src="/stranger-things-sm.png" alt="image" className="h-full"/>
                            <div className="flex justify-between items-center w-full">
                                <div className="flex flex-col gap-0">
                                    <span className="text-md lg:text-lg font-bold">Stranger Things</span>
                                    <spna className="text-sm text-blue-500">Downloading...</spna>
                                </div>
